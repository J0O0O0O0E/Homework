...
public class Test {
	...
	private static void testAddStudent() { // ----------添加学生-------------
	...
	public static void testListStudentsByYear() {// ----------指定年份-------------
	...
	public static void testListStudentsNames() {// ----------指定年份的姓名-------------
	...
	public static void testMapStudentsBySex() {// ----------按性别分组-------------
	...
	public static void testRemoveStudent() {// ----------删除学生-------------
